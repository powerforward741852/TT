...
#pragma mark ----- Channel -----
        ...
        NSString *channel = [NSString stringWithFormat:@"%d",SYS_NEWS_CHANNEL];
...
#pragma mark ----- channel -----
        [self.manager.requestSerializer setValue:[NSString stringWithFormat:@"%d",SYS_NEWS_CHANNEL] forHTTPHeaderField:@"channel"];
